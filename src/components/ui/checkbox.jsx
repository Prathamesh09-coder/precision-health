import React, { useCallback, useEffect, useState, createContext, useContext, forwardRef } from "react";
...
const CarouselContent = forwardRef(function CarouselContent(
  ...
  const { carouselRef, orientation } = useCarousel_allowSafe();
...
/* helper to avoid crash if used outside */
function useCarousel_allowSafe() {
...
const CarouselItem = forwardRef(function CarouselItem(
  ...
  const { orientation } = useCarousel_allowSafe();
...
const CarouselPrevious = forwardRef(function CarouselPrevious(
  ...
  const { orientation, scrollPrev, canScrollPrev } = useCarousel_allowSafe();
...
const CarouselNext = forwardRef(function CarouselNext(
  ...
  const { orientation, scrollNext, canScrollNext } = useCarousel_allowSafe();
